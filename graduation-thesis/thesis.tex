...
\begin{figure}[H]
	...
	\caption{Transformer\cite{vaswani_attention_nodate}}
...
\begin{figure}[H]
	...
	\caption{Transformerを構成するMulti-Head Attention（右）とそれを構成すScaled Dot-Product Attention（左）\cite{vaswani_attention_nodate}}
