...
事前に学習されたSentence-BERTのモデルには\textcolor{red}{，}
% ，ライブラリにデフォルトで提供されている
Nilsら\textcolor{red}{の}paraphrase-MiniLM-L6-v2を使用した\textcolor{red}{．
% 省略可能
文}章間の
% 非類似度
距離の算出には
...
図\ref{claim_sentences_dendrogram}に主張の\textcolor{red}{文の}階層的クラスタリングの結果を示す．
...
その結果，高い適合率で分類を行い，\textcolor{red}{個々のクラスタから}類似した出来事の異なる主張を推薦できた．
\textcolor{red}{今後の課題として，誤分類した文の特徴の精査やより多くの文での評価，クラスタ間の距離の算出方法の改善や階層の分け方の改善を行う必要がある．}
% /**
