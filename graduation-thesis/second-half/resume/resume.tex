...
\title{記事トピックのクラスタを用いた多言語ニュース推薦手法の提案}
...
% オンラインニュースサイト
Webニュース
には世界の記者たちの様々な主張が散見されるが，言語の違いによる時間的コストなどから，多くの読者はそれらの主張の一部しか把握できない．

そこで本研究では，閲覧記事と取り扱う出来事が類似する世界の記事を抽出し，得た記事から主張が異なる文章を推薦するシステムを提案する．
