...
\begin{figure}[H]
	\centering
	\includegraphics[keepaspectratio, width=80mm]{img/bubble_ui.png}
	% \caption{あるSNS投稿者の投稿のうち，SNSに推薦されている投稿のカテゴリと推薦されていない投稿のカテゴリの境界を可視化したシステム\protect\footnotemark[10]}
	\caption{フィルターバブルを可視化するシステム\protect\footnotemark[10]}
	\label{fig_bubble_ui}
\end{figure}
\footnotetext[10]{\cite{nagulendra_understanding_2014}より引用}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{\textcolor{red}{話題の定量化によるニュース推薦を行う研究}}
% @see 
...
\subsection{Bangla News Recommendation Using doc2vec}
~
LDAとdoc2vecについて
BERTによる文脈を考慮した埋め込みの方が優れているとの見解を記す
% @see 
