#!/bin/bash
#
# @file      process_07_sentences_cluster_generator_with_threshold.sh
# @author    Kataoka Nagi (calm1836[at]gmail.com)
# @brief     execute process_07_sentences_cluster_generator_with_threshold.py
...
SRC_DIR="process_07_sentences_cluster_generator_with_threshold.py"
