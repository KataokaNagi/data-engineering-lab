#!/bin/bash
#
# @file      process_06_articles_cluster_generator_with_maximal_silhoette.sh
# @author    Kataoka Nagi (calm1836[at]gmail.com)
# @brief     execute process_06_articles_cluster_generator_with_maximal_silhoette.py
...
SRC_DIR="process_06_articles_cluster_generator_with_maximal_silhoette.py"
