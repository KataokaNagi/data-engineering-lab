#!/bin/bash
#
# @file      process_07_sentences_cluster_generator.sh
# @author    Kataoka Nagi (calm1836[at]gmail.com)
# @brief     execute process_07_sentences_cluster_generator.py
...
SRC_DIR="process_07_sentences_cluster_generator.py"
