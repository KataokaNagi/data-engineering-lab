"""
@file      preprocess_05_split_sentences_for_debater_dataset.py
@author    Kataoka Nagi (calm1836[at]gmail.com)
@brief     split sentences with '#' by periods other than appreviate periods
@date      2021-12-11 14:38:09
@version   1.0
...
def main():
    ...
    dist_dirs = [
        "./IBM_Debater_(R)_CE-EMNLP-2015.v3/claims_preprocess-03_split-sentences.txt",
        "./IBM_Debater_(R)_CE-EMNLP-2015.v3/evidence_preprocess-03_split-sentences.txt"]
