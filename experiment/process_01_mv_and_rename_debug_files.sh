#!/bin/bash
#
# @file      process_01_mv_and_rename_debug_files
...
mv covid-19-news-articles/*process-02* covid-19-news-articles/archive/process-02_classified-claim-or-evidence_debug/
